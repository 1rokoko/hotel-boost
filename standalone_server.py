#!/usr/bin/env python3
"""
Standalone server with original admin dashboard template
"""
...
async def admin_dashboard(request: Request):
    try:
        ...
        return HTMLResponse(f"<h1>Template Error</h1><p>{e}</p><p>Check if app/templates/admin_dashboard.html exists</p>")
...
@app.get("/")
async def root():
    return {"message": "Standalone server with original design!", "status": "ok"}

if __name__ == "__main__":
    print("🚀 Starting standalone server with original admin dashboard...")
